package com.hayden.multiagentidelib.acp
...
import com.hayden.multiagentidelib.model.acp.ChatMemoryContext
    ...
    private class AcpSessionOperations(
        ...
        override suspend fun fsReadTextFile(
            ...
            if (line == null && limit == null) {
                return ReadTextFileResponse(Paths.get(path).readText())
            }
